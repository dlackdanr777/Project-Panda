...
public class Furniture : Item
{
    ...
    public Furniture(string id, string name, string description, string storyId, int price, string rank, string map, FurnitureType type, Sprite image, Sprite roomImage) : base(id, name, description, price, rank, map, image) 
    {
        StoryId = storyId;
        Type = type;
        RoomImage = roomImage;
